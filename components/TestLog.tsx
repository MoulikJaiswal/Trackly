...
export const TestLog: React.FC<TestLogProps> = ({ tests, targets = [], onSave, onDelete }) => {
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in duration-500">
      ...
      {isAdding && (
        <Card className="border-indigo-100 dark:border-indigo-500/30 bg-indigo-50 dark:bg-indigo-500/5">
      ...
      <div className="grid gap-4">
        {tests.length === 0 ? (
          <div className="text-center py-20 opacity-60 border-2 border-dashed border-slate-300 dark:border-white/10 rounded-3xl bg-white/30 dark:bg-white/5">
            ...
            <Card key={t.id} className="group" delay={i * 0.1}>
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                     <h3 className="text-slate-900 dark:text-white font-bold text-base md:text-lg">{t.name}</h3>
                ...
                <div className="text-right">
                  <span className="text-2xl md:text-3xl font-light text-slate-900 dark:text-white font-mono">{t.marks}</span>
                  <span className="text-xs text-slate-500 font-bold ml-1">/{t.total}</span>
                </div>
              </div>
              {t.analysis && (
                <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-2xl border-l-4 border-indigo-500/40 mb-4">
      ...
      {/* Upcoming Tests Section - Moved to Bottom */}
          ...
          <div className="pt-8 border-t border-slate-200 dark:border-white/10 mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {upcomingTests.map(t => {
                      ...
                      return (
                          <div key={t.id} className="bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 p-4 rounded-2xl relative overflow-hidden group">
